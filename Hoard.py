...
class Clicker:
    def __init__(self):
        ...
        self.xcoords = [420,1157,230,555,230,559,230,559,369,658]
        self.ycoords = [365,218,344,344,487,487,630,630,702,92]
        self.xcoords2 = [557,603,680,736,793]
        self.ycoords2 = [230,238,236,226,236]
        self.colours = [(128,123,78),(115,53,41),(115,95,65),(123,86,86),(65,107,115)]
        self.x,self.y = 420,325
...
##            print(self.num_press)
    ...
    def party_click(self):
        if self.pre:
##            win.mouse_event(con.MOUSEEVENTF_WHEEL,0,0,2000,0)
##            t.sleep(.5)
...
##            win.mouse_event(con.MOUSEEVENTF_LEFTUP,self.xcoords[1],self.ycoords[1],0,0)
    ...
    def goto_page(self):
        py.click(415,50)
        py.typewrite("https://pokefarm.com/stats/hoard",pause=.2)
        t.sleep(1.5)
        py.press("return",pause=.2)
        t.sleep(3)
        py.click(10,360)
        py.scroll(round(self.scroll_amount))
        t.sleep(1.5)
        py.click(572,501)
